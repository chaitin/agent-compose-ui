...
<style>
  ...
  .eyebrow { margin-bottom: .35rem; color: var(--accent-blue-bright); font-size: .72rem; font-weight: 700; letter-spacing: .12em; text-transform: uppercase; }
  time { color: var(--text-secondary); font-size: .82rem; }
  ...
  article span { color: var(--text-secondary); font-size: .85rem; }
  article strong { align-self: end; font-size: 2rem; line-height: 1; }
  .state { padding: 1rem; border: 1px solid var(--border-color); border-radius: .65rem; color: var(--text-secondary); }
