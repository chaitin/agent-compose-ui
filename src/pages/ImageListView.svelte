...
<style>
  ...
  button,select,input{border:1px solid var(--border-color);border-radius:4px;background:var(--bg-tertiary);color:var(--text-secondary);padding:6px 8px;font-size:var(--font-size-sm)}button:focus-visible,input:focus-visible,select:focus-visible{outline:2px solid var(--accent-blue);outline-offset:2px}.header-actions{display:flex;gap:7px}.primary{background:var(--accent-blue-emphasis);color:var(--text-on-accent)}.filters{display:flex;align-items:center;gap:8px;padding:12px 0}.filters>input{min-width:260px}.filters label{display:flex;align-items:center;gap:5px;font-size:var(--font-size-xs)}.filters label input,.select-cell input{accent-color:var(--accent-blue)}.filter-spacer{flex:1}.selection-count{color:var(--text-muted);font:var(--font-size-xs) var(--font-mono)}.bulk-danger,.danger{color:var(--accent-red);border-color:color-mix(in srgb,var(--accent-red) 55%,transparent);background:color-mix(in srgb,var(--accent-red) 6%,transparent)}
  ...
  .image-row{display:grid;grid-template-columns:34px 1fr;align-items:stretch;padding-left:10px;border-bottom:1px solid var(--border-color);background:transparent}.image-row.expanded{background:color-mix(in srgb,var(--accent-blue) 5.5%,transparent);box-shadow:inset 2px 0 var(--accent-blue)}.row-trigger{display:grid;grid-template-columns:minmax(230px,2fr) 92px .8fr .65fr .65fr 1fr;gap:10px;align-items:center;width:100%;padding:9px 10px;border:0;border-radius:0;background:transparent;text-align:left}.row-trigger:hover{background:var(--bg-secondary)}.ref{min-width:0}.ref strong,.ref small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.ref strong{color:var(--text-primary);font:var(--font-size-sm) var(--font-mono)}.ref small{margin-top:3px;color:var(--text-muted);font:var(--font-size-xs) var(--font-mono)}.error-text{color:var(--accent-red)}
  .type-pill{display:inline-block;padding:2px 7px;border:1px solid color-mix(in srgb,var(--accent-green) 40%,transparent);border-radius:10px;color:var(--accent-green);background:color-mix(in srgb,var(--accent-green) 8%,transparent);font-size:var(--font-size-xs);font-weight:600}.type-pill.intermediate{color:var(--accent-yellow);border-color:color-mix(in srgb,var(--accent-yellow) 45%,transparent);background:color-mix(in srgb,var(--accent-yellow) 8%,transparent)}
  .detail-row{position:relative;padding:16px 18px 17px 54px;border-bottom:1px solid var(--border-color);background:linear-gradient(90deg,color-mix(in srgb,var(--accent-blue) 7%,transparent),transparent 42%),var(--bg-secondary)}.detail-row::before{content:'';position:absolute;left:26px;top:0;bottom:0;width:1px;background:color-mix(in srgb,var(--accent-blue) 35%,transparent)}.detail-title{display:flex;justify-content:space-between;align-items:start;margin-bottom:12px}.detail-title h2{margin:3px 0 0;color:var(--text-primary);font:var(--font-size-md) var(--font-mono)}.detail-state{padding:12px;color:var(--text-muted);font-size:var(--font-size-sm)}.detail-state.error{color:var(--accent-red)}dl{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;margin:0}dl>div{min-width:0;padding:9px 10px;border:1px solid color-mix(in srgb,var(--border-color) 75%,transparent);background:color-mix(in srgb,var(--bg-primary) 55%,transparent)}dl>.inspect-size{display:none}dt{margin-bottom:4px;color:var(--text-muted);font-size:var(--font-size-xs);text-transform:uppercase}dd{margin:0;overflow-wrap:anywhere;color:var(--text-secondary);font:var(--font-size-xs) var(--font-mono)}.labels{display:flex;align-items:center;flex-wrap:wrap;gap:6px;margin-top:10px;font-size:var(--font-size-xs)}.labels strong{margin-right:4px;color:var(--text-muted)}.labels code{padding:3px 6px;background:var(--bg-tertiary);color:var(--text-secondary)}.labels span{color:var(--text-muted)}.more{display:block;margin:10px auto}
