...
<style>
  ...
  button{border:1px solid var(--border-color);border-radius:4px;background:var(--bg-tertiary);color:var(--text-secondary);padding:7px 10px}.danger{color:var(--text-on-accent);background:var(--accent-red);border-color:var(--accent-red)}button:disabled{opacity:.55}
