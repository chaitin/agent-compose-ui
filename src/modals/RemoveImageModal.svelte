...
<style>
  ...
  .modal{position:fixed;z-index:101;top:50%;left:50%;transform:translate(-50%,-50%);width:min(560px,92vw);max-height:min(720px,88vh);display:flex;flex-direction:column;background:var(--bg-secondary);border:1px solid var(--border-color);border-top-color:var(--border-color);border-radius:9px;box-shadow:0 24px 80px #000b;color:var(--text-secondary)}
  ...
  button{border:1px solid var(--border-color);border-radius:4px;background:var(--bg-tertiary);color:var(--text-secondary);padding:7px 10px}.danger{color:var(--accent-red);background:color-mix(in srgb,var(--accent-red) 8%,var(--bg-secondary));border-color:var(--accent-red)}.danger:hover:not(:disabled){color:var(--accent-red);background:color-mix(in srgb,var(--accent-red) 12%,var(--bg-secondary))}button:disabled{opacity:.55}
  .targets{border:1px solid var(--border-color);border-radius:6px;overflow:hidden}.targets>div{display:grid;grid-template-columns:18px 1fr auto;gap:8px;align-items:center;padding:8px 10px;border-bottom:1px solid var(--border-color);background:color-mix(in srgb,var(--bg-primary) 50%,transparent)}.targets>div:last-child{border:0}.targets i{font-style:normal;color:var(--text-muted)}.targets code{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--text-primary)}.targets small{color:var(--text-muted)}.targets .succeeded i{color:var(--accent-green)}.targets .failed i{color:var(--accent-red)}
  ...
  .outcome{display:grid;grid-template-columns:minmax(100px,1fr) 1fr;gap:3px 10px;padding:8px 10px;border-left:2px solid var(--accent-green);background:var(--bg-tertiary);font-size:var(--font-size-xs)}.outcome.failed{border-color:var(--accent-red)}.outcome code{color:var(--text-primary)}.outcome span{color:var(--text-secondary)}.outcome.failed span{color:var(--accent-red)!important}.warning{color:var(--accent-yellow)!important}.outcome small{grid-column:1/-1;color:var(--text-muted)}
</style>
